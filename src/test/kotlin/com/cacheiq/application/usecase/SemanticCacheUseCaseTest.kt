...
class SemanticCacheUseCaseTest {
    ...
    fun setup() {
        ...
        metrics = mockk()
        tokenCounter = mockk()
        every { tokenCounter.countTokens(any()) } returns 5
        ...
        useCase = SemanticCacheUseCase(embeddingAdapter, llmClient, piiDetector, cacheRepository, metrics, config, tokenCounter)
    }
